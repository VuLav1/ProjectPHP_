...
<a href="index.php?action=products&act=insert_hanghoa"><h4>Thêm sản phẩm</h4></a>
</div>
<div class="row">
<table class="table">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="index.php?action=products&act=update_hanghoa&id=<?php echo $set['mahh'];?>">Cập nhật</a></td>
        <td><a href="">Xóa</a></td>
      </tr>
     <?php
      endwhile;
