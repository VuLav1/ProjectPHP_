...
switch ($act) {
    ...
    case 'forget_action':
        if (isset($_POST['submit_email'])) {
            ...
            $kh = new user();
            $checkuser = $kh->checkMail($email)->rowCount();
            if ($checkuser > 0) {
                ...
                $mail->Username = "anhvuppe25@gmail.com"; //
                // GMAIL password
                // $mail->Password = "php22023ngoc";
                $mail->Password = "ymzt jsvu cobs hexj"; //Phplytest20@php
                $mail->SMTPSecure = "tls";  // ssl
                // sets GMAIL as the SMTP server
                $mail->Host = "smtp.gmail.com";
                // set the SMTP port for the GMAIL server
                $mail->Port = "587"; // 465
                $mail->From = 'anhvuppe25@gmail.com';
                $mail->FromName = 'Vu';
